...
const NODE_DEFS = {
  ...
  // =============================================================
  // RESEARCH CENTER INTERNAL UPGRADE TREE (#8 New technologies)
  // =============================================================
  'node_rc_point_gain': {
    id: 'node_rc_point_gain',
    num: '#RC1',
    name: 'Point Gain',
    tag: 'RC MULTIPLIER',
    category: 'research_center',
    lore: 'Increases ₽ gain by +1x per level, starting at x1.',
    icon: '⚡',
    baseCost: D(1),
    costMult: 1.18,
    currency: 'research',
    maxLevel: 20,
    effectDescription: (lvl) => `Increases ₽ gain by +${lvl}x (starting at x1).`
  },
  'node_rc_left_side': {
    id: 'node_rc_left_side',
    num: '#RC-L',
    name: 'Left Side',
    tag: 'EXPANSION',
    category: 'research_center',
    lore: 'Unlocks more upgrades on the left side of the main tree.',
    icon: '⬅️',
    baseCost: D(0),
    costMult: 1,
    currency: 'research',
    maxLevel: 1,
    isPermanent: true,
    effectDescription: 'Unlocks left-wing point and mobility upgrades.'
  },
  'node_rc_right_side': {
    id: 'node_rc_right_side',
    num: '#RC-R',
    name: 'Right Side',
    tag: 'EXPANSION',
    category: 'research_center',
    lore: 'Unlocks more upgrades on the right side of the main tree.',
    icon: '➡️',
    baseCost: D(0),
    costMult: 1,
    currency: 'research',
    maxLevel: 1,
    isPermanent: true,
    effectDescription: 'Unlocks right-wing scientific branches.'
  },
  'node_rc_point_gain_2': {
    id: 'node_rc_point_gain_2',
    num: '#RC2',
    name: 'Point Gain 2',
    tag: 'RC MULTIPLIER',
    category: 'research_center',
    lore: 'Increases ₽ gain by +0.1x per level, starting at x1.',
    icon: '🔹',
    baseCost: D(100),
    costMult: 1.25,
    currency: 'research',
    maxLevel: 50,
    effectDescription: (lvl) => `Increases ₽ gain by +${(lvl * 0.1).toFixed(1)}x.`
  },
  'node_rc_point_gain_3': {
    id: 'node_rc_point_gain_3',
    num: '#RC3',
    name: 'Point Gain 3',
    tag: 'RC MULTIPLIER',
    category: 'research_center',
    lore: 'Increases ₽ gain by +0.01x per level, starting at x1.',
    icon: '💠',
    baseCost: D(100000),
    costMult: 1.3,
    currency: 'research',
    maxLevel: 100,
    effectDescription: (lvl) => `Increases ₽ gain by +${(lvl * 0.01).toFixed(2)}x.`
  },
  'node_rc_point_gain_4': {
    id: 'node_rc_point_gain_4',
    num: '#RC4',
    name: 'Point Gain 4',
    tag: 'RC MULTIPLIER',
    category: 'research_center',
  ...
  'node_rc_point_gain_5': {
    id: 'node_rc_point_gain_5',
    num: '#RC5',
    name: 'Point Gain 5',
    tag: 'RC MULTIPLIER',
    category: 'research_center',
  ...
  'node_rc_point_gain_6': {
    id: 'node_rc_point_gain_6',
    num: '#RC6',
    name: 'Point Gain 6',
    tag: 'RC MULTIPLIER',
    category: 'research_center',
    lore: 'Increases ₽ gain by +0.5x per level, starting at x1.',
    icon: '⚛️',
    baseCost: D(100000000),
    costMult: 1.45,
    currency: 'research',
    maxLevel: 50,
    effectDescription: (lvl) => `Increases ₽ gain by +${(lvl * 0.5).toFixed(1)}x.`
  },
  'node_rc_point_gain_1b': {
    id: 'node_rc_point_gain_1b',
    num: '#RC-1B',
    name: 'Point Gain 1B',
    tag: 'RC MULTIPLIER',
    category: 'research_center',
    lore: 'Increases ₽ gain by x2 per level compounding, starting at x1.',
    icon: '✨',
    baseCost: D(1000000000),
    costMult: 2.0,
    currency: 'research',
    maxLevel: 25,
    effectDescription: (lvl) => `×${D(2).pow(lvl).format(0)} compounding ₽ gain.`
  },
  'node_rc_point_gain_x': {
    id: 'node_rc_point_gain_x',
    num: '#RC-X',
    name: 'Point Gain X',
    tag: 'RC MULTIPLIER',
    category: 'research_center',
  ...
  'node_rc_materialize_1': {
    id: 'node_rc_materialize_1',
    num: '#M1',
    name: 'Materialize',
    tag: 'CAP EXPANDER',
    category: 'research_center',
    lore: '+1 max level to upgrade #1.',
    icon: '🧱',
    baseCost: D(3000000),
    costMult: 1,
    currency: 'research',
    maxLevel: 1,
    isPermanent: true,
    effectDescription: '+1 max level to upgrade #1.'
  },
  'node_rc_materialize_2': {
    id: 'node_rc_materialize_2',
    num: '#M2',
    name: 'Materialize 2',
    tag: 'CAP EXPANDER',
    category: 'research_center',
    lore: '+1 max level to upgrades #2 and #3.',
    icon: '🏗️',
    baseCost: D(500000000),
    costMult: 1,
    currency: 'research',
    maxLevel: 1,
    isPermanent: true,
    effectDescription: '+1 max level to upgrades #2 and #3.'
  },
  'node_rc_materialize_3': {
    id: 'node_rc_materialize_3',
    num: '#M3',
    name: 'Materialize 3',
    tag: 'CAP EXPANDER',
    category: 'research_center',
    lore: '+1 max level to upgrades #5 and #6.',
    icon: '🏛️',
    baseCost: D(10000000000),
    costMult: 1,
    currency: 'research',
    maxLevel: 1,
    isPermanent: true,
    effectDescription: '+1 max level to upgrades #5 and #6.'
  },
  'node_rc_materialize_4': {
    id: 'node_rc_materialize_4',
    num: '#M4',
    name: 'Materialize 4',
    tag: 'CAP EXPANDER',
    category: 'research_center',
    lore: '+1 max level to upgrades #4, #7, and #8.',
    icon: '🏰',
    baseCost: D(100000000000),
    costMult: 1,
    currency: 'research',
    maxLevel: 1,
    isPermanent: true,
    effectDescription: '+1 max level to upgrades #4, #7, and #8.'
  },
  'node_rc_materialize_5': {
    id: 'node_rc_materialize_5',
    num: '#M5',
    name: 'Materialize 5',
    tag: 'CAP EXPANDER',
    category: 'research_center',
    lore: '+1 max level to upgrade #10, +5 max levels to upgrade #12.',
    icon: '🪐',
    baseCost: D(1000000000000),
    costMult: 1,
    currency: 'research',
    maxLevel: 1,
    isPermanent: true,
    effectDescription: '+1 max level to upgrade #10, +5 max levels to upgrade #12.'
  },
  'node_rc_materialize_1b': {
    id: 'node_rc_materialize_1b',
    num: '#M1B',
    name: 'Materialize 1B',
    tag: 'CAP EXPANDER',
    category: 'research_center',
  ...
  'node_rc_extender': {
    ...
    tag: 'CAP EXPANDER',
    category: 'research_center',
    lore: "Increases Point Gain 5's level cap by 100 per level.",
    icon: '📏',
    baseCost: D(50000000),
    costMult: 2.5,
    currency: 'research',
    maxLevel: 10,
    effectDescription: (lvl) => `+${lvl * 100} level cap to Point Gain 5.`
  },
  'node_rc_darkness_1': {
    id: 'node_rc_darkness_1',
    num: '#DRK1',
    name: 'Darkness 1',
    tag: 'DARK MATTER',
    category: 'research_center',
    lore: 'Increases ₽X gain by +1x per level, starting at x1.',
    icon: '🌑',
    baseCost: D(1000000000000000),
    costMult: 2.0,
    currency: 'research',
    maxLevel: 20,
    effectDescription: (lvl) => `Increases ₽X gain by +${lvl}x.`
  },
  'node_rc_global_chat': {
    id: 'node_rc_global_chat',
    num: '#CHAT',
    name: 'Global Chat',
    tag: 'COSMIC RELAY',
    category: 'research_center',
    lore: 'Allows your terminal to receive simulated interstellar transmissions from other architect servers.',
    icon: '📡',
    baseCost: D(1000000000000000), // 1 Qdλ
    costMult: 1,
    currency: 'research',
    maxLevel: 1,
    isPermanent: true,
    effectDescription: 'Unlocks the Global Chat Terminal.'
  },
  'secret_beyond_analysis': {
    id: 'secret_beyond_analysis',
    num: 'SECRET',
    name: 'Beyond Analysis',
    tag: 'OBSCURITY RELIC',
    category: 'secret',
    lore: 'Looks like you found me x100QnDe. A hidden cosmic relic discovered at coordinates (-550, 3244).',
    icon: '👁️',
    x: -550,
    y: 3244,
    baseCost: D(1000000),
    ...
    maxLevel: 1,
    isPermanent: true,
    effectDescription: 'Awards the hidden "Beyond Analysis" Obscurity Badge & grants immense x100QnDe boost.'
  }
...
const RESEARCH_CENTER_NODE_IDS = [
  'node_rc_point_gain',
  'node_rc_left_side',
  'node_rc_right_side',
  'node_rc_point_gain_2',
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { NODE_DEFS, PRESTIGE_NODE_IDS, RESEARCH_CENTER_NODE_IDS };
} else {
  window.NODE_DEFS = NODE_DEFS;
  window.PRESTIGE_NODE_IDS = PRESTIGE_NODE_IDS;
  window.RESEARCH_CENTER_NODE_IDS = RESEARCH_CENTER_NODE_IDS;
}
